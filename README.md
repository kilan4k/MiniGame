...
* **Character Creation**: Select from 7 starting character archetypes ("New character", "Bandit", "Punchman", "Archer", "Leveled up Punchman", "Lumberjack", "Robber") by name or list index, and assign a custom player nickname.
